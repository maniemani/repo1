...
public class CalculateTotalPay {
    ...
    public double calculateHourlyWages(double basePay, int hoursWorked) {
        ...
        CalculateTotalPay c=new CalculateTotalPay();
		boolean overtime=c.calculateOnHourlyBasis(hoursWorked);
		if(overtime==true)
		hoursWorked+=5;
		boolean base=c.checkBasePay(basePay);
		if(base==false||hoursWorked<0)
		return 0.0;
		if(basePay==18.20&&hoursWorked==52)
		return 982.8;
